# -*- coding: utf-8 -*-
"""
Created on Fri Nov 15 20:44:54 2019
...
#fpr, tpr, auc_thresholds  = roc_curve(y_validate, status[:,1])
 
#plot_roc_auc = auc(fpr, tpr)
...
# Calculate roc auc
roc_value = roc_auc_score(test_labels, status)
...
#test['Delivery_Time'] = number.inverse_transform(test['Delivery_Time'])

#for var in cat_cols:
    #number = LabelEncoder()
    #print ("var : "+var)
    #print ("test : "+test[var].values)
    #test[var] = number.inverse_transform(test[var].astype('str'))
